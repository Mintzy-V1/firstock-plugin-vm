...
_raw_pyramid_cash_override = os.environ.get("PYRAMID_FREE_CASH_OVERRIDE", "none")
...
class AutoTrader:
    ...
    def _push_live_pnl_to_redis(self) -> None:
        ...
        try:
            ...
            self._debug_live_pnl(
                f"redis:write:{sid}",
                (
                    f"[LIVE-PNL-REDIS] setex key={live_pnl_key(sid)} ttl=5 "
    ...
    def _run_eod_exit_body(self):
        ...
        self.alerts.notify("14:50 IST - Initiating exit of session positions")
